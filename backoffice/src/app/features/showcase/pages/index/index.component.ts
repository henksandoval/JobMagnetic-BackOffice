    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      >
        <div class="flex items-center">
          ...
          <h3 class="ml-4 text-lg font-semibold text-gray-800 dark:text-gray-100" i18n>Forms</h3>
        </div>
        <p class="mt-3 text-sm text-gray-600 dark:text-gray-400" i18n>
      ...
      <div class="block p-6 bg-white dark:bg-slate-800/50 rounded-lg shadow-md cursor-not-allowed">
        <div class="flex items-center">
          ...
          <h3 class="ml-4 text-lg font-semibold text-gray-500 dark:text-gray-400" i18n>
            Tables (Coming Soon)
          </h3>
        </div>
        <p class="mt-3 text-sm text-gray-500 dark:text-gray-500" i18n>
